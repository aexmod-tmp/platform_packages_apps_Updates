 ...
 */
package com.syberia.ota.misc;

import android.app.AlarmManager;

public class Constants {
    // Download related
    public static final String UPDATES_FOLDER = "Syberia-Updates";
    public static final String DOWNLOAD_ID = "download_id";
    public static final String DOWNLOAD_NAME = "download_name";
    public static final String DOWNLOAD_TMP_EXT = ".tmp";
    public static final String DOWNLOAD_CHANNEL_ID = "com.syberia.ota.DOWNLOAD_CHANNEL";
    public static final String DOWNLOADING_CHANNEL_ID = "com.syberia.ota.DOWNLOADING_CHANNEL";
    // Preferences
    ...
    public static final String CURRENT_BUILD_TYPE = "ro.syberia.releasetype";
    public static final String OTA_URL = "https://syberiaos.com/OTA/%s";
    // Expressions
